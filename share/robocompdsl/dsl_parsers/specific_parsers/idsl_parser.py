...
class IDSLParser(DSLParserTemplate):
    ...
    def string_to_struct(self, string, **kwargs):
        ...
        if 'imports' in parsing_result:
            ...
            # print ('imports', parsing_result['imports'])
            # print (type(parsing_result['imports']))
            result_dict['imports'] = '#'.join(parsing_result['imports'])
            # print ('recursive_imports', parsing_result['recursive_imports'])
            # print (type (parsing_result['recursive_imports']))
